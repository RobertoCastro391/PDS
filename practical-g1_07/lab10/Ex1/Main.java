...
public class Main {
    ...
    public static void main(String[] args){
        ...
        Produto p1 = new Produto("Poster da Sara", 10000.0);
        Produto p2 = new Produto("Uma Pedra", 200.0);
        ...
        Cliente c1 = new Cliente("Sardinha Almeida");
        Cliente c2 = new Cliente("Zé Luis Zé Nuno");
        Cliente c3 = new Cliente("Abrunhosa Sobrinha");

        Gestor g1 = new Gestor("Dan Dotson");

        System.out.println("==================================== LEILOEIRA Rolão de Castro ====================================");
        System.out.println();
